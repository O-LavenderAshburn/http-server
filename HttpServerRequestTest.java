...
class HttpServerRequestTest
{
	...
	assertTrue(hsr.isDone());
	Assertions.assertEquals("foobar.com",hsr.getHost());
	Assertions.assertEquals("foo" ,hsr.getFile());
    ...
    void badGet1() {
      ...
      Assertions.assertEquals(null,hsr.getFile());
    ...
    void emptyFirst() {
      ...
      assertTrue(hsr.isDone());
      Assertions.assertEquals(null,hsr.getFile());
      Assertions.assertEquals(null,hsr.getHost());
    }
